...
class TAD(object):
    ...
    async def rules(self, ctx):
        ...
        embed.add_field(name="<a:pointer:440925289317531668>    ** DRAMA FREE ZONE**", value="Do not create server drama or take part in it. If you have any problem with the server, talk to the staff via DMs.", inline=False)
